...
export async function GET(req: NextRequest) {
  ...
  const logs = sessions.map((s) => {
    ...
    return {
      ...
      game_rate: s.game_rate,
      game_rate_type: s.game_rate_type,
      game_rate_after_6pm: s.game_rate_after_6pm,
      game_rate_type_after_6pm: s.game_rate_type_after_6pm,
      switch_pricing_at_6pm: s.switch_pricing_at_6pm,
